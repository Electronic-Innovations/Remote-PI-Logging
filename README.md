...
#### Assesing and Padding Raw Data - Not Required if graphing with Graph.py and _graph.py
...
#### Appending to a Continous data set - Not Required if graphing with Graph.py and _graph.py
